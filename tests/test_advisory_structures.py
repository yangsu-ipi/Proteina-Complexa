...
def test_a_failed_structure_write_stops_the_run(tmp_path, monkeypatch):
    ...
    def exploding_scorer(target_seqs, binder_seq, cfg, out_pdb_path, draw, context=None, out_path_for=None, **_):
...
def test_a_fold_that_merely_fails_is_still_survivable(tmp_path, monkeypatch):
    ...
    def flaky_scorer(target_seqs, binder_seq, cfg, out_pdb_path, draw, context=None, out_path_for=None, **_):
